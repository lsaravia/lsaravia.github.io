---
title: "Multifractals in ecology using R - Day 5"
date: 2013-08-30 19:06
collection: teaching
type: "Posgraduate course"
date: 2013-07-26
venue: "University of Maringá"
location: "Brasil"
---

## Not everything is fractal  

* Halley (2004) states that Before fractality can be affirmed, a power-law relationship between scale and our 
	variable of interest should hold over a reasonable number of scales. If we want to demonstrate the existence 
	of self-similar mechanisms we should have a reasonable good number of points between our minimum and maximum scales. 
	...
	+ The folowing figure shows the distribution of microphytobenthos chlorophyll-a concentration (modified from Seuront 2009) as a continous pattern (A) or a discrete pattern (B) and the scaling behaviour (C) where $\delta$ is the scale
